                ...
                <section id="two" className="main style2">
                    <div className="grid-wrapper">
                        ...
                        <div className="col-6">
                            ...
                            <p>To learn more about my skills and background, please download a PDF of my <a href="https://sokradychey.dev/images/Sokrady-Chey-Rev-Resume-2019.pdf">CV Here</a>.</p>
                        </div>
                    </div>
                </section>
                    ...
                    <div className="grid-wrapper">
                        ...
                        <div className="col-4">
                            ...
                            <ul className="actions">
                                <li><a href="https://codepen.io/Schey1993/pen/rPeKNm" className="button">Demo</a></li>
                                <li><a href="https://github.com/sokradyschey/Pokemon-Flash-Cards" className="button">Code</a></li>
                        ...
                        <div className="col-4">
                            ...
                            <ul className="actions">
                                <li><a href="https://codepen.io/Schey1993/pen/jZvPoV" className="button">Demo</a></li>
                                <li><a href="https://github.com/sokradyschey/random-quote-machine" className="button">Code</a></li>  
                            </ul>
                        </div>
                        <div className="col-4">
                            ...
                            <ul className="actions">
                                <li><a href="https://github.com/sokradyschey/catch-of-the-day" className="button">Code</a></li>
                            </ul>
                        </div>
