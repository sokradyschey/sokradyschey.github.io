...
class TypeMapper {
        ...
        val = () => {
          ...
          if (isInputType(wrappedType)) {
            return {
              ...
              defaultValue: this.getInputDefaultValue(value, wrappedType)
            };
          } else {
  ...
  makeInputFieldDef(def) {
    ...
    return (0, _keyValMap.default)(def.fields, field => field.name.value, field => {
      ...
      if (Array.isArray(field.directives) && _values.getDirectiveValues) {
        const vars = (0, _values.getDirectiveValues)(_default.default, field);
  ...
  getInputDefaultValue(value, type) {
